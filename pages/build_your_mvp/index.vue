          ...
          >
            <div
              class="
                ...
                d-flex
                flex-column
                align-items-center align-items-sm-center align-items-md-start
              "
            ></div>
                ...
                <div class="div-form">
                  ...
                  >
                    <form
                      ...
                      novalidate
                    >
                      <input type="hidden" name="form-name" value="entrepreneur_form" />
                      ...
                      >
                        ...
                        >
                          <div class="text-white p-2 flex-fill text-center">
                            ...
                            ></object>
                            <h5>Backend</h5>
                            <p>Java, NodeJS, Python</p>
                          </div>

                          <div class="text-white p-2 flex-fill text-center">
                            <object
                              data="/images/frontend.svg"
                              width="60"
                              height="60"
                            ></object>
                            <h5>Frontend</h5>
                            <p>HTML5, CSS, Angular, React JS, Bootstrap</p>
                          </div>

                          <div class="text-white p-2 flex-fill text-center">
                            <object
                              data="/images/mobile.svg"
                              width="60"
                              height="60"
                            ></object>
                            <h5>Mobile</h5>
                            <p>iOS, Android, Ionic, React Native</p>
                          </div>

                          <div class="text-white p-2 flex-fill text-center">
                            <object
                              data="/images/infra.svg"
                              width="60"
                              height="60"
                            ></object>
                            <h5>Infrastructure</h5>
                            <p>AWS, Google Cloud, Firebase, Oracle, Mysql</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        >
                         ...
                         <a
                            ...
                            href=""
                            ><div class="img-container">
                                <img class="img-client4" src="~/assets/crea_white.png" alt="">
                                </div
                          ></a> 
                        </div>
                      </div>
